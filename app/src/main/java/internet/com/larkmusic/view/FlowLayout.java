...
public class FlowLayout extends ViewGroup {
    ...
    private Map<String, Integer> compute(int flowWidth) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            child.setTag(new Rect(rowsWidth - childWidth + marginParams.leftMargin, columnHeight + marginParams.topMargin, rowsWidth - marginParams
                    .rightMargin, columnHeight + childHeight - marginParams.bottomMargin));
        }
